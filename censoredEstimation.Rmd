...
$$\begin{aligned} E \left(\sum_{x_i \in \mathbf{y}} y_i + \sum_{x_i \in \mathbf{l}}l_i + \sum_{x_i \in \mathbf{r}} r_i\right) = \sum_{x_i \in \mathbf{y}} y_i + \sum_{x_i \in \mathbf{l}}\frac{\min\{\theta^{(p-1)},c_{(1,i)}\} -\min\{\theta^{(p-1)},c_{(1,i)}\}e^{-c_{(1,i)}/\theta^{(p-1)}}}
